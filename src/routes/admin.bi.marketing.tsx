...
export const Route = createFileRoute("/admin/bi/marketing")({
  component: () => <BIPage title="Marketing" desc="Traffic sources, WhatsApp click tracking, and top performing products." />,
});

function BIPage({ title, desc }: { title: string; desc: string }) {
  return (
    <div>
      <h1 className="font-serif text-3xl text-ivory mb-2">{title}</h1>
