...
export const Route = createFileRoute("/admin/bi/financial")({ component: () => <BIPage title="Financial" desc="Gift request budget breakdown and delivery zone revenue distribution." /> });
