...
export const Route = createFileRoute("/admin/bisupport")({ component: () => <BIPage title="Support" desc="Unified view of gift requests, contact form submissions, and enquiries." /> });
